...
parser = argparse.ArgumentParser(description="Create production branch")
...
branch_name = f"prod/{tag_version}"

create_branch(branch_name, args.sha, args.repo, args.gh_token)

...
from datta_pipeline_library.transformation.finance.landing_raw.execute import execute_landing_raw_fi_d
from datta_pipeline_library.transformation.finance.raw_euh.execute import execute_raw_euh_fi_d
...
execute_landing_raw_fi_d(spn, base_config)
execute_raw_euh_fi_d(spn, base_config, collibra_config)

...
def create_UC_table(path,uc_catalog_name,uc_schema_name,data_layer, table_list1):
    ...
    #added below code to resolve Upper issue
...
dlt_table_list = ['BKPF', 'GLPCA', 'DS1HM_MT_BB','DS1HM_MT_BB01','Aecorsoft_BKPF','Aecorsoft_GLPCA','Aecorsoft_DS1HM_MT_BB','Aecorsoft_DS1HM_MT_BB01','Aecorsoft_BKPF_archive','Aecorsoft_GLPCA_archive','Aecorsoft_DS1HM_MT_BB_archive','Aecorsoft_DS1HM_MT_BB01_archive']

...
#BSEG_STN Transform Load Landing to Raw
...
def load_BSEG_STN(spn, base_config):
        
    #:param spn: Azure SPN used to call the Databricks REST API
    #:param base_config: BaseConfig object
        
    logging.info("Started data load for BSEG_STN from Landing to Raw")
...
StructField("PAYS_PROV", StringType(), True),
StructField("PAYS_TRAN", StringType(), True),
StructField("MNDID", StringType(), True),
StructField("XFRGE_BSEG", StringType(), True),
...
StructField("IGNR_IVREF", StringType(), True),
StructField("FMFGUS_KEY", StringType(), True),
StructField("FMXDOCNR", StringType(), True),
StructField("FMXYEAR", StringType(), True),
StructField("FMXDOCLN", StringType(), True),
StructField("FMXZEKKN", StringType(), True),
...
StructField("SQUAN", StringType(), True),
...
StructField("J_1TPBUPL", StringType(), True),
StructField("GST_PART", StringType(), True),
StructField("PLC_SUP", StringType(), True),
StructField("HSN_SAC", StringType(), True),
StructField("IRN", StringType(), True),
StructField("RECRF", StringType(), True),
StructField("INWARD_NO", StringType(), True),
StructField("INWARD_DT", StringType(), True),
StructField("GROUND_NO", StringType(), True),
StructField("GROUND_DT", StringType(), True),
StructField("GROUND_TYP", StringType(), True),
StructField("PYMTKEY", StringType(), True),

    ])
    )
    dataset_name = "BSEG_STN"
    ...
    logging.info("Completed data load for BSEG_STN from Landing to Raw")

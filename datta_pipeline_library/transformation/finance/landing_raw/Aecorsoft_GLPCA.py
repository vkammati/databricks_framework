"""
Aecorsoft GLPCA Transform Load Landing to Raw
"""
...
from pyspark.sql.types import StringType, StructType, StructField, IntegerType, DecimalType, DoubleType, BinaryType,DateType,TimestampType
from datta_pipeline_library.core.landing_raw import landing_raw,landing_raw_batch, landing_raw_aecorsoft
# from datta_pipeline_library.expectations.landing_raw import cost_management
from datta_pipeline_library.core.transform_basic import transform_yrmono

def load_Aecorsoft_GLPCA(spn, base_config):
    """
    ...
    # partitions = ["yrmono"]
    partitions = None
    # TODO: we had to comment as GE was crashing the driver
    ge_rules = None  # GSAP_ECC_GLPCA.expectations
    ...
    logging.info("Completed data load for Aecorsoft GLPCA from Landing to Raw")

"""
DS1HM_MT_BB01 Transform Load Landing to Raw  
"""
...
def load_DS1HM_MT_BB01(spn, base_config): 
    """
    ...
    logging.info("Completed data load for DS1HM_MT_BB01 from Landing to Raw")

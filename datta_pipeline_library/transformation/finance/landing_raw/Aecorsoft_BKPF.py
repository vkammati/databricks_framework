"""
Aecorsoft BKPF Transform Load Landing to Raw
"""
import logging
...
def load_Aecorsoft_BKPF(spn, base_config):
    """
    ...
    logging.info("Completed data load for Aecorsoft BKPF from Landing to Raw")

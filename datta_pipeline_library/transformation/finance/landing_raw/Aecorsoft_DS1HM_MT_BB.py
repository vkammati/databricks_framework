"""
Aecorsoft DS1HM_MT_BB Transform Load Landing to Raw
"""
import logging
...
def load_Aecorsoft_DS1HM_MT_BB(spn, base_config):
    """
    ...
    logging.info("Completed data load for Aecorsoft DS1HM_MT_BB from Landing to Raw")

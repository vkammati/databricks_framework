...
#GLIDXA_TSAP Transform Load Landing to Raw
...
def load_GLIDXA_TSAP(spn, base_config):
        
    #:param spn: Azure SPN used to call the Databricks REST API
    #:param base_config: BaseConfig object
        
    logging.info("Started data load for GLIDXA_TSAP from Landing to Raw")
...
StructField("SYSTEM_ID", StringType(), True),
    ...
    logging.info("Completed data load for GLIDXA_TSAP from Landing to Raw")

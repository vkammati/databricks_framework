...
#ZSTVA_PE_MC_DTL_STN Transform Load Landing to Raw
...
def load_ZSTVA_PE_MC_DTL_STN(spn, base_config):
        
    #:param spn: Azure SPN used to call the Databricks REST API
    #:param base_config: BaseConfig object
        
    logging.info("Started data load for ZSTVA_PE_MC_DTL_STN from Landing to Raw")
...
StructField("SYSTEM_ID", StringType(), True),
    ...
    dataset_name = "ZSTVA_PE_MC_DTL_STN"
    ...
    logging.info("Completed data load for ZSTVA_PE_MC_DTL_STN from Landing to Raw")
